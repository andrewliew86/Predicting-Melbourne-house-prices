...
df.to_pickle('melb_real_estate_carnegie_surrounding_30Jan21') # I pickle the dataframe so that I dont have to keep scraping the website to look at the data
print (df) # just print out the dataframe to have a look!
df = pd.read_pickle('melb_real_estate_carnegie_surrounding_30Jan21')
df.to_csv('melb_real_estate_carnegie_surrounding_30Jan21.csv', encoding='utf-8', index=False)