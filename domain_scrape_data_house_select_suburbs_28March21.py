# Getting data from domain.com for housing price prediction Melbourne (2+ bedrooms but below 700 000)
# We are looking specifically at 10 suburbs: Carnegie, Bentleigh, Bentleigh East, Caulfield, Elsternwick, Gardenvale, Glen Huntly, McKinnon, Murrumbeena, Ormond
...
df.to_pickle('melb_real_estate_carnegie_surrounding_28March21') # I pickle the dataframe so that I dont have to keep scraping the website to look at the data
print (df) # just print out the dataframe to have a look!
df = pd.read_pickle('melb_real_estate_carnegie_surrounding_28March21')
df.to_csv('melb_real_estate_carnegie_surrounding_28March21.csv', encoding='utf-8', index=False)